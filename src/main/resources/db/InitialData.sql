...
INSERT INTO chain(chain_id, name, chain_type, rpc_url) VALUES ('1001', 'BAOBAB', 'TEST_CHAIN', 'https://api.baobab.klaytn.net:8651');
INSERT INTO chain(chain_id, name, chain_type, rpc_url) VALUES ('20221', 'Cerulean', 'TEST_CHAIN', 'https://iskra-dev:DMDD1EgBqHC3gSITcJqq@chain.iskra.cloud/cerulean');
...
INSERT INTO contract_type(
    name, platform_name )
VALUES ('GAME_TOKEN', 'GAME');

INSERT INTO contract_type(
    name, platform_name )
VALUES ('GAME_NFT', 'GAME');
